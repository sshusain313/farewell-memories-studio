  ...
  const buildAndDownload = async () => {
    ...
    try {
      await downloadImage('template-33.png', {
        cols: 8,
        rows: 10, // Increased to include bottom row and extension row
        ...
        draw: async ({ drawKey, ctx, width, height }) => {
          ...
          const extensionCells = 5;
          const startCol = 1.5; // Start at 1.5 to center 5 cells in 8 columns
          ...
          console.log('Extension row layout:', {
            totalWidth: 8,
            extensionCells: 5,
            startCol: 2,
            endCol: 6,
